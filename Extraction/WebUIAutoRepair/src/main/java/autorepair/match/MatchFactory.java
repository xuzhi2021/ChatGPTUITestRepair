...
//                return matchByChatGPT(oldStateMachine, newStateMachine, oldEvent);
    ...
    public static String matchByEditDistance(StateMachineImpl oldStateMachine, Event oldEvent, StateMachineImpl newStateMachine, WebDriver driver) throws IOException {
        ...
        String old_xpath=preDomNodeInfo.getXpath();
...
//        storeSpecificCandidates(old, packageClassName, lineNum, gt_xpath, oldEvent, oldStateMachine, newStateMachine, size, driver, "xpath");
    ...
    public static String matchByWebevo(WebDriver driver, StateMachineImpl oldStateMachine, StateMachineImpl newStateMachine, Event oldEvent) throws IOException {
        ...
        //return verifyXPath(preDomNodeInfo, xpath, oldStateMachine, newStateMachine, oldEvent,driver);
        return xpath;
    }
    ...
    public static String matchBySFTM2023(StateMachineImpl oldStateMachine, StateMachineImpl newStateMachine, Event oldEvent, WebDriver driver)
        ...
        //below is for verifying the result
//        String sftm2023_re=sftm.getNewXpath(oldEvent.getAbsoluteXpath());
//
//        List<PreDomNodeInfo> oldPreDomNodeInfoList = JsonProcess.readPreDomNodeInfoJson(oldStateMachine.getSavePath() + File.separator
//                + oldEvent.getSourceVertexId() + File.separator + "preDomNodeInfo.json");
//        PreDomNodeInfo preDomNodeInfo = null;
...
//            }
//        }
//        return verifyXPath(preDomNodeInfo, sftm2023_re, oldStateMachine, newStateMachine, oldEvent,driver);
