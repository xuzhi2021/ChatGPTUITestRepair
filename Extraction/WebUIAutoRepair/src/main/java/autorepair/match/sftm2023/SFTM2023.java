...
public class SFTM2023 {
    ...
    public static void main(String[] args) {
        ...
        /**
         * id:参数
         * path:你TEST_001.exe的路径
         */
        String path = Settings.sftmPath + "net6" + File.separator + "SFTM.exe";
        String oldHTML = "D:\\rep\\webUIDataset\\data\\test\\old\\old.html";
        String newHTML = "D:\\rep\\webUIDataset\\data\\test\\new\\new.html";
        String output = "D:\\\\sustech\\\\cxh_lab\\\\lyz_essay\\\\e0117\\\\webUIDataset-main\\\\data\\\\null\\\\result2.json";
...
//        System.out.println(new SFTM2023().normalizeXpath("/BODY/DIV[0]/DIV[0]/DIV[2]/A[0]".toLowerCase(Locale.ROOT)));
    ...
    public Process match(String param1, String param2) {
        ...
        System.out.println("执行exe成功" + outputPath);
        return p;
    }
